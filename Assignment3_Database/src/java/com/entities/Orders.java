...
public class Orders {
    ...
    public Orders(Integer giftOrderID, String giftOrderName, int giftOrderQuantity, double giftOrderDiscount, double giftOrderPrice, double discountedPrice, double totalPrice, String giftOrderColors, String giftOrderCategory) {
